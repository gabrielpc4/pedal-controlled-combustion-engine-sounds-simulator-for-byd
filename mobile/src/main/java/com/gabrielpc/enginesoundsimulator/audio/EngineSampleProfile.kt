...
internal data class SampleLayerSpec(
    ...
    fun playbackRatio(rpm: Double): Double {
        ...
        return ((autopitchRootRpm?.let { rpm / it } ?: 1.0) * authoredPitch)
            .coerceIn(0.10, 4.0)
    }
    ...
    fun gainAt(rpm: Double, throttle: Double): Double {
        ...
        return amplitude * dbToLinearGain(decibels)
    }
}
...
private fun huracanTrofeoEvo2Profile(): EngineSampleProfile {
...
private fun dbToLinearGain(decibels: Double): Double = 10.0.pow(decibels / 20.0)
