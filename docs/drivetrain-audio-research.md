...
The present POC uses a fixed 8,250-RPM performance upshift and ratio-safe downshifts. The crossover calculation is the recommended next tuning refinement.
