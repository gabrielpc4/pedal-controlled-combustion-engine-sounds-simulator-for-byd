"""Canonical Assetto Corsa 1.16.4 Kunos and official-DLC car identifiers.

The game does not consistently put an ``author`` field in ``ui_car.json``.
Using that field to distinguish mods consequently treats every authorless mod
as official.  The compiler instead intersects the installed directories with
this immutable list from the complete first-party 1.16.4 distribution.
"""
...
# These Steam-installed first-party placeholders intentionally have neither
# physics nor an FMOD bank and therefore are not usable catalog entries.
UNUSABLE_OFFICIAL_CAR_IDS = frozenset(
    {"ks_ferrari_488_challenge_evo", "ks_ferrari_488_gt3_2020"}
)

EXPECTED_OFFICIAL_DIRECTORIES = 180
